...
local highlights = {
	...
	MiniStarterItemBullet = { fg = colors.black_bright.gui, ctermfg = colors.black_bright.cterm }, -- Bullet points
	...
	MiniStarterFooter = { fg = colors.black_bright.gui, ctermfg = colors.black_bright.cterm }, -- Footer text
}
